...
class EnhancedFarmMarket {
    ...
    setupDemoData() {
        ...
        // Setup demo products
        this.products = [
            { id: 1, name: "Fresh Tomatoes", price: 4.99, image: "../tomatoes.jpg", category: "vegetables", farmer: "Johnson's Farm", description: "Vine-ripened tomatoes picked fresh this morning" },
            { id: 2, name: "Organic Carrots", price: 3.49, image: "../carrots.jpg", category: "vegetables", farmer: "Green Valley Farm", description: "Sweet, crunchy carrots grown without pesticides" },
            { id: 3, name: "Fresh Cabbage", price: 2.99, image: "../cabbage.jpg", category: "vegetables", farmer: "Sunny Acres Farm", description: "Crisp cabbage perfect for salads and cooking" },
            { id: 4, name: "Garden Potatoes", price: 5.99, image: "../potatoes.jpg", category: "vegetables", farmer: "Hillside Farm", description: "Fresh potatoes ideal for any recipe" },
            { id: 5, name: "Sweet Onions", price: 3.99, image: "../onions.jpg", category: "vegetables", farmer: "Valley View Farm", description: "Sweet yellow onions with mild flavor" },
            { id: 6, name: "Fresh Lettuce", price: 2.49, image: "../veg1.jpg", category: "vegetables", farmer: "Fresh Greens Farm", description: "Crispy lettuce leaves for fresh salads" }
        ];
    }
